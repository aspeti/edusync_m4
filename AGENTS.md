...
| **PROMPT_MAPPING** | `docs/PROMPT_MAPPING.md` | Catálogo de prompt-contratos `PR-<AREA>-NNN` — v2.12 (43 contratos activos: PR-ARCH..PR-POC-002, PR-C4-003..006, PR-ROADMAP-001, PR-APORTES-001, PR-VFINAL-001, PR-IMPL-001..006; los seis `PR-IMPL-*` **ejecutados**, incl. `PR-IMPL-006` consola Angular de Usuarios y Roles) |
...
│                                      — 43 contratos en total contando PR-IMPL-001..006 en docs/prompts/impl/
...
├── frontend/                        ← ✅ SPA Angular 21.2.19 LTS (PR-IMPL-001 esqueleto + PR-IMPL-004/006 UI, 04/08/2026)
...
│       ├── features/usuarios/       ← ✅ consola Admin: lista/alta/roles/estado/reset (DD-UC-006, sin delta backend)
