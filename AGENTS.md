...
├── README.md
├── AGENTS.md                        ← este archivo (v0.19) — convención GitHub/Cursor, raíz requerida por la rúbrica del Módulo 4
...
- [ ] Ejecución de `PR-IMPL-001`, `PR-IMPL-002` y `PR-IMPL-003` (generación real del código en `backend/`, `frontend/`, `infra/`) — `src/` sigue vacío; siguiente paso concreto de implementación.
