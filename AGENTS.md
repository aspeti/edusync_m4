...
| **PROMPT_MAPPING** | `docs/PROMPT_MAPPING.md` | Catálogo de prompt-contratos `PR-<AREA>-NNN` — v2.10 (42 contratos activos: PR-ARCH..PR-POC-002, PR-C4-003..006, PR-ROADMAP-001, PR-APORTES-001, PR-VFINAL-001, PR-IMPL-001..005; los cinco `PR-IMPL-*` **ejecutados**, incl. `PR-IMPL-005` CRUD de Usuarios y Roles) |
...
│   │   └── DTP.md                   ← Documento Técnico del Producto v1.12 (ADR-0008/0009/0010/0011/0012 registrados en §A.2)
...
│   │   └── DD-UC-005.md             ← CRUD backend de Usuarios y Roles (FSD-UC-021 completo; ejecutado, 04/08/2026)
...
│                                      — 42 contratos en total contando PR-IMPL-001..005 en docs/prompts/impl/
...
│                                      72/72 tests verde (incluye ModularityTests 7/7). Los 5 prompts IMPL
...
│       ├── identidad/               ← ✅ real (PR-IMPL-002 + PR-IMPL-005) — Usuario/UsuarioRol, login JWT,
│       │                              TenantContextProvider, seed SYSADMIN, UsuarioCreacionPort, CRUD de
│       │                              Usuarios/Roles (UsuarioController, PasswordResetToken/Controller)
│       │                              (FSD-UC-021 completo backend, DD-UC-002/005)
...
- [x] Sincronizado con `docs/PROMPT_MAPPING.md` v2.10 (42 prompt-contratos + carpeta `prompts/`; área `IMPL` con 5 filas `PR-IMPL-001..005`, las cinco en `docs/prompts/impl/` y las cinco **ejecutadas**).
