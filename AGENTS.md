...
| **PROMPT_MAPPING** | `docs/PROMPT_MAPPING.md` | Catálogo de prompt-contratos `PR-<AREA>-NNN` — v2.21 (48 contratos activos: PR-ARCH..PR-POC-002, PR-C4-003..006, PR-ROADMAP-001, PR-APORTES-001, PR-VFINAL-001, PR-IMPL-001..011; `PR-IMPL-001`..`011` **todos ejecutados**, incl. `PR-IMPL-008`/`PR-IMPL-009` — módulo `academico`, `GestionEscolar` backend + UI Angular — y `PR-IMPL-010`/`PR-IMPL-011` — módulo `academico`, `Curso`/`Paralelo` backend + UI Angular) |
...
| **DTP (capa viva)** | `docs/product/DTP.md` | Documento Técnico del Producto v1.22 (21/08/2026) — continuación viva del DTI congelado; §A.3 marca `FSD-UC-011`, `FSD-UC-012`, `FSD-UC-017` y `FSD-UC-021` como **completos** (backend + UI, incl. filtros/paginación); `PR-IMPL-007`..`PR-IMPL-011` **ejecutados** (134/134 tests backend, `ng build` verde) |
...
├── README.md
├── AGENTS.md                        ← este archivo (v0.33) — convención multi-agente (Cursor + Claude)
