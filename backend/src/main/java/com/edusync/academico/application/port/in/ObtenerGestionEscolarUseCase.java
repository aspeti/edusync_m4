 ...
 * Exclusivo {@code ADMIN} ({@code DD-UC-021}); el resto de roles usa
 * {@link ObtenerGestionEscolarActivaUseCase}.
 */
public interface ObtenerGestionEscolarUseCase {

  /**
   * @throws com.edusync.academico.domain.GestionEscolarNoEncontradaException si no existe o
   *     es de otro tenant
   */
