...
| `docs/product/DTP.md` | §A.1 nueva fila (login/identidad); §A.3 `FSD-UC-021` pasa de `pendiente` a `en progreso` (parcial: solo autenticación, CRUD completo queda en `DD-UC-004`) | no (uso normal de la capa viva, sin cambio de requisitos) |
