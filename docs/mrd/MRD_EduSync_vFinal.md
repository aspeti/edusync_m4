...
>
> Este archivo es un snapshot inmutable de docs/mrd/MRD_EduSync.md (version v1.0) congelado el 28/05/2026 por el contrato prompts/PR-VFINAL-001.md para la entrega del Modulo 4.
>
> **No editar este archivo.** Para cambios normativos:
> 1. Modifica el documento canonico (docs/mrd/MRD_EduSync.md).
> 2. Regenera este alias mediante PR-VFINAL-001 o sync-doc-chain en su pasada de release.
>
> | Campo | Valor |
> |-------|-------|
> | Fuente canonica | docs/mrd/MRD_EduSync.md |
